...
@Client.on_message(filters.command(['music', 'mp3']) & filters.private)
async def song(client, message):
    ...
    for i in message.command[1:]:
        query += ' ' + str(i)
    print(query)
    m = await message.reply(f"**ѕєαrchíng чσur ѕσng...!(⌐■_■)\n {query}**")
    ...
    try:
        ...
        cap = "**BY›› [𝗡𝗧𝗠](https://t.me/llathu63035)\n\n CREDITS » [LATHEESH](https://t.me/TG_LATHEESH/3) **"
...
async def vsong(client, message: Message):
    ...
    try:
        ...
        return await pablo.edit_text(f"**𝙳𝚘𝚠𝚗𝚕𝚘𝚊𝚍 𝙵𝚊𝚒𝚕𝚎𝚍 𝙿𝚕𝚎𝚊𝚜𝚎 𝚃𝚛𝚢 𝙰𝚐𝚊𝚒𝚗 After Some Time ..♥️** \n**Error :** `{str(e)}`")       
